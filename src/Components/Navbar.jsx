...
import amapianologo from '../assets/amapianologo.avif'; // Adjust the path as necessary 
...
const Navbar = () => {
  ...
  return (
    <nav className="border-gray-200 dark:bg-gray-900 z-30 text-white">
...
/>
  ...
  type="button"
  className="text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-base w-48 px-6 py-3 text-center me-2 mb-2"
>
  Blog
